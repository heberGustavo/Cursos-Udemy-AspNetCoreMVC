...
namespace ValidacaoRemotaa.Controllers
{
    public class PessoasController : Controller
    {
        private readonly PessoasContexto _context;

        public PessoasController(PessoasContexto context)
        {
            _context = context;
        }
        ...
        {
            if (await _context.Pessoas.AnyAsync(x => x.Nome == nome))
