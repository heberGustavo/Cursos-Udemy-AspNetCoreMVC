...
namespace UmParaUm.Controllers
{
    public class EnderecoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EnderecoId,Rua,Numero,Bairro,Cidade")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnderecoId,Rua,Numero,Bairro,Cidade")] Endereco endereco)
        {
