...
namespace UmParaUm.Controllers
{
    public class PessoasController : Controller
    {
        ...
        {
            var contexto = _context.Pessoa.Include(p => p.Endereco);
        ...
        {
            ViewData["EnderecoId"] = new SelectList(_context.Endereco, "EnderecoId", "EnderecoId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("PessoaId,Nome,Idade,EnderecoId")] Pessoa pessoa)
        {
            ...
            ViewData["EnderecoId"] = new SelectList(_context.Endereco, "EnderecoId", "EnderecoId", pessoa.EnderecoId);
            return View(pessoa);
        }
