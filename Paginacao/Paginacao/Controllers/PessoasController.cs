...
//Necessario instalar pacote 'X.PagedList.Mvc.Core'
namespace Paginacao.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? pagina)
        {
            ...
            //Se pagina for nula recebe 1, a primeira pagina, senão recebe o valor da variavel pagina
            int paginaAtual = (pagina ?? 1);
            return View(await _context.Pessoas.ToPagedListAsync(paginaAtual, itensPorPagina));
        }
